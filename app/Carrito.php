...
class Carrito extends Model
{
    ...
    public static function get_products(){
        ...
        return $products = Carrito::where('id_usuario', 1)
                    ->select('carritos.id_carrito as id', 'diseno_cuellos.imagen_inicial', 'carritos.cantidad as cantidad', 'carritos.orden_number', 'carritos.created_at', 'diseno_cuellos.nombre_diseno', 'talla_cuellos.nombre_talla', 'valor_modelos.valor_modelo', 'modelo_cuellos.nombre_modelo')
