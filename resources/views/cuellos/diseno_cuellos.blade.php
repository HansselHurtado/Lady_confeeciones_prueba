            ...
            <div class="content_category pb-4 border border-primary">
                ...
                <nav>
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="#" class="btn color_button text-white">Diseñar</a>
                    </div>
                </nav>
            </div>
                ...
                <div class="w-100 d-flex flex-wrap">
                    @foreach ($diseno_cuellos as $diseno_cuello)
                        <div class="container_cuello pb-2">
                            <div class="item_cuello  text-center text-color mx-2 vaciar_talla" data-toggle="modal" data-target="#Modal_detalle_cuello " onclick="detalles_cuello('{{$diseno_cuello->nombre_diseno}}','{{$diseno_cuello->id_diseno_cuello}}',' {{$diseno_cuello->nombre_modelo}}','{{$diseno_cuello->material}}')">
                                    ...
                                    <img width="180px" height="200px"  src="{{ asset('/img/fondo_cuello/'.$diseno_cuello->imagen_inicial) }}" alt="">
                            </div>
                            <div class="item_description d-flex flex-column align-items-center vaciar_talla" data-toggle="modal" data-target="#Modal_detalle_cuello" onclick="detalles_cuello('{{$diseno_cuello->nombre_diseno}}','{{$diseno_cuello->id_diseno_cuello}}',' {{$diseno_cuello->nombre_modelo}}','{{$diseno_cuello->material}}')">
                                ...
                                <button class="btn color_button text-white">Comprar</button>
                            </div>
                        </div>
                    @endforeach                    
                </div>
